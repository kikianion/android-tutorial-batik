    ...
    <div class="wrapper" ng-app="aneon-manager">
        ...
        <header class="main-header">
            ...
            <a href="javascript: return false;" class="logo hidden-xs">
                ...
                <span class="logo-lg"><b>Batik</b></span>
            </a>

            <!-- Header Navbar -->
            <nav class="navbar navbar-static-top" role="navigation">
                <!-- Sidebar toggle button-->
                <a href="javascript:return false;" class="sidebar-toggle hidden-xs" data-toggle="offcanvas"
                   role="button">
                    <span class="sr-only">Toggle navigation</span>
                </a>
                <a id="back-btn-header" href="javascript:window.history.back()"
                   style="float: left; padding: 15px; color: white" class="xhidden-xl xhidden-lg xhidden-md "
                   ng-hide="hideBack">
        ...
        <aside class="main-sidebar">
            ...
            <section class="sidebar">
                ...
                <ul class="sidebar-menu">
                    ...
                    sort_($menuGroup, "order");

                    foreach ($menuGroup as $key => $val) {
                        ?>
                        <!-- dynamic menu loader abc4455-->
                        <li class="treeview">
                            <a href="javascript:return false;"><i class='fa fa-folder'></i>
                                <span><?php echo $key ?></span> <i
                            ...
                            <ul class="treeview-menu">
                                ...
                                foreach ($val as $keyItemMenu => $itemMenu) {
                                    ...
                                    if ($itemMenu['openNewWindow'] != "") {
                                        ...
                                        ?>
                                        <li><a <?php echo $targetBlank ?>
                                                href="#/page/<?php echo $itemMenu['filename'] ?>/<?php echo $itemMenu['title'] ?>"><i
                                                    class='fa fa-circle-o'></i>
                                                <span><?php echo $itemMenu['title'] ?></span></a>
                                        </li>
                                        <?php
        ...
        <footer class="main-footer center-navbar">
            ...
            <!-- Default to the left -->
            <strong>&copy; 2017 <a href="#">Lamongan</a>.</strong>
        </footer>
