...
<section class="content">
    ...
    <script type="text/javascript">
        ...
        (function (_SELF) {
            ...
            var hot_options = {
                colHeaders: ['#', 'name', 'phone', 'globalId', 'created', 'modified',],
                colWidths: [1, 200, 100, 100, 100, 100,
                    100, 100, 100, 100, 100],
                columns: [
                    {
                        readOnly: 1,
            ...
            _SELF.hot.loadData(
                function (res) {
                    ...
                    for (var i = 0, ilen = res.data.length; i < ilen; i++) {
                        ...
                        row[2] = res.data[i].phone;
                        row[3] = res.data[i].globalId;
                        row[4] = UTCtoJakarta(res.data[i].created);
                        row[5] = UTCtoJakarta(res.data[i].modified);
