...
//setting
$pageParams = array(
    'title' => "Deteksi Jurnal Harian",
    'menuGroup' => "Setting",
    'ds'=>"dayjournal_detect_set",
    'order'=>2,
);
...
<section class="content">
    ...
    <script type="text/javascript">
        ...
        (function(_SELF) {
            ...
            var hot_options = {
                colHeaders: ['#', 'name', 'pengurang', 'keyword', 'start find', 'end find', 'created'],
                colWidths: [1, 200, 80, 200, 200, 200, 200,
                    100, 100, 100, 100, 100
                ],
                columns: [{}, {
            ...
            _SELF.hot.loadData(
                function(res) {
                    ...
                    for (var i = 0, ilen = res.data.length; i < ilen; i++) {
                        ...
                        row[2] = res.data[i].subtractor;
                        row[3] = res.data[i].keyword;
                        row[4] = res.data[i].startFind;
                        row[5] = res.data[i].endFind;
                        row[6] = UTCtoJakarta(res.data[i].created);
