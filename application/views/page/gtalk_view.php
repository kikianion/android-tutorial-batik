...
<section class="content">
    ...
    <script type="text/javascript">
        ...
        (function (_SELF) {
            ...
            var hot_options = {
                colHeaders: ['#', 'created', 'direction', 'target', 'cnt', 'deviceId',],
                colWidths: [1, 200, 100, 150, 300, 150,
                    100, 100, 100, 100, 100
                ],
                columns: [{
                    readOnly: 1,
            ...
            _SELF.hot.loadData(
                function (res) {
                    ...
                    for (var i = 0, ilen = res.data.length; i < ilen; i++) {
                        ...
                        row[2] = res.data[i].direction;
                        row[3] = res.data[i].target;
                        row[4] = res.data[i].cnt;
                        row[5] = res.data[i].deviceId;
